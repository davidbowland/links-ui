              ...
              <Grid item md sm={12}>
                <Stack spacing={1}>
                  <Typography variant="body2">
                    This site only uses essential cookies such as those used to keep you logged in. If you choose to
                    sign up, we collect your phone number simply to prevent fraud and to keep costs low. Depending on
                    your activity, your IP address may appear in our logs for up to 90 days. We never sell your
                    information, but we do collect device and site usage information using{' '}
